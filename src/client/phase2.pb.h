...
#ifndef PROTOBUF_phase2_2eproto__INCLUDED
#define PROTOBUF_phase2_2eproto__INCLUDED
...
void  protobuf_AddDesc_phase2_2eproto();
void protobuf_AssignDesc_phase2_2eproto();
void protobuf_ShutdownFile_phase2_2eproto();
...
class Person_PhoneNumber : public ::google::protobuf::Message {
 ...
 private:
  ...
  ::std::string* number_;
  int type_;
  friend void  protobuf_AddDesc_phase2_2eproto();
  friend void protobuf_AssignDesc_phase2_2eproto();
  friend void protobuf_ShutdownFile_phase2_2eproto();
...
// optional string debug = 5;
inline bool Person::has_debug() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void Person::set_has_debug() {
  _has_bits_[0] |= 0x00000008u;
}
inline void Person::clear_has_debug() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void Person::clear_debug() {
  if (debug_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    debug_->clear();
  }
  clear_has_debug();
}
inline const ::std::string& Person::debug() const {
  // @@protoc_insertion_point(field_get:Person.debug)
  return *debug_;
}
inline void Person::set_debug(const ::std::string& value) {
  set_has_debug();
  if (debug_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    debug_ = new ::std::string;
  }
  debug_->assign(value);
  // @@protoc_insertion_point(field_set:Person.debug)
}
inline void Person::set_debug(const char* value) {
  set_has_debug();
  if (debug_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    debug_ = new ::std::string;
  }
  debug_->assign(value);
  // @@protoc_insertion_point(field_set_char:Person.debug)
}
inline void Person::set_debug(const char* value, size_t size) {
  set_has_debug();
  if (debug_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    debug_ = new ::std::string;
  }
  debug_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:Person.debug)
}
inline ::std::string* Person::mutable_debug() {
  set_has_debug();
  if (debug_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    debug_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:Person.debug)
  return debug_;
}
inline ::std::string* Person::release_debug() {
  clear_has_debug();
  if (debug_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void Person::set_allocated_debug(::std::string* debug) {
  if (debug_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete debug_;
  }
  if (debug) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Person.debug)
}
...
#endif  // PROTOBUF_phase2_2eproto__INCLUDED
